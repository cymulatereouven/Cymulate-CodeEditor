...
import { CymulateCodeEditorSettingsState } from './voidSettingsService.js'
...
export type CymulateCodeEditorStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
type CommonProviderSettings = {
	...
	models: CymulateCodeEditorStatefulModelInfo[],
}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with CymulateCodeEditor. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: CymulateCodeEditorStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: CymulateCodeEditorSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: CymulateCodeEditorSettingsState) => {
