...
export const IMetricsPollService = createDecorator<IMetricsPollService>('cymulateCodeEditorMetricsPollService');
class MetricsPollService extends Disposable implements IMetricsPollService {
	_serviceBrand: undefined;

	static readonly ID = 'cymulateCodeEditorMetricsPollService';
