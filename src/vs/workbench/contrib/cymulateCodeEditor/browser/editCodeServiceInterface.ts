...
import { Diff, DiffArea, CymulateCodeEditorFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getCymulateCodeEditorFileSnapshot(uri: URI): CymulateCodeEditorFileSnapshot;
	restoreCymulateCodeEditorFileSnapshot(uri: URI, snapshot: CymulateCodeEditorFileSnapshot): void;
}
